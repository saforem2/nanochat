...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        choices=["cuda", "xpu", "cpu", "mps"],
        help="Device type for evaluation: cuda|xpu|cpu|mps. empty => autodetect",
    )
    args = parser.parse_args()

    device_type = (
        ezpz.get_torch_device_type() if args.device_type == "" else args.device_type
    )
